...
*Null hypothesis: The probability of a student guessing the correct flavor is no different than the probability of randomly picking a flavor for each sample *

*Alternative hypothesis: students guess the correct flavor of a jelly bean better than when selections are left to pure chance *
...
chisq.test(y = jellyDat$Correct, x = jellyDat$Initials, correct = F)

```

*p-val: 0.306; test statistic: 44* 
...
*With a p-val of .306, this indicates that students cannot reliably guess the correct flavor of a jelly bean. Our p-val indicates that there is ~30% chance that the students *
