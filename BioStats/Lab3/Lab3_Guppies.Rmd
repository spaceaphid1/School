...
*The null hypothesis is that male infection status does not have an effect on female preference (equal visitation by females). The alternative hypothesis is that infection status does have an effect on female preference (differential visitation); in this case, they predict that females will visit the uninfected males more; this would require a 1-tailed test, as they are predicting directional variable behavior*
...
*The standard error of our success estimate is .089*
...
*Your P-value and interpretation here * 
